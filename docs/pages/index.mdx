...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>```bash copy pnpm add @unrulyeon/react-indexeddb ```</Tab>
  <Tab>```bash copy npm i @unrulyeon/react-indexeddb ```</Tab>
  <Tab>```bash copy yarn add @unrulyeon/react-indexeddb ```</Tab>
  <Tab>```bash copy bun add @unrulyeon/react-indexeddb ```</Tab>
</Tabs>
